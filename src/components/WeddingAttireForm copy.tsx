...
const WeddingAttireForm: React.FC<WeddingAttireFormProps> = ({ onClose, vendor, mode }) => {
  ...
  const categoryOptions = [
    'All Attire', 'Bridal Collection', 'Groom Collection', 'Designer Wear', 
    'Traditional Wear', 'Contemporary Wear'
  ];
  ...
  const addArrival = () => {
    if (arrivals.length < 3) {
      const newId = Math.max(...arrivals.map(a => a.id)) + 1;
      setArrivals(prev => [
        ...prev,
        { id: newId, title: '', image: null, preview: '' },
      ]);
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* Multi-Select Searchable Cities Dropdown */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
